...
const DialogTitle = forwardRef(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("text-lg font-semibold font-(--font-heading) text-(--text-primary)", className)}
    {...props}
  />
));
