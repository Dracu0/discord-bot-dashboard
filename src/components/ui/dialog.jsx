...
const DialogTitle = forwardRef(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("text-lg font-semibold font-[var(--font-heading)] text-[var(--text-primary)]", className)}
    {...props}
  />
));
